package org.ibiscum.sbbc.controller

import org.ibiscum.sbbc.service.ManualTaskSchedulerService
...
@RestController
class TestController(private val manualTaskSchedulerService: ManualTaskSchedulerService) {
